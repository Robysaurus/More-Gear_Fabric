...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    HYPHITE("hyphite", 1000, new int[] {4,9,8,4}, 18, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.15f, 0.15f, () -> Ingredient.ofItems(ModItems.HYPHITE)),
    PHENON("phenon", 2500, new int[] {6,11,9,6}, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.25f, 0.165f, () -> Ingredient.ofItems(ModItems.PHENON)),
    ENDIUM("endium", 4000, new int[] {9,13,11,7}, 27, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.18f, () -> Ingredient.ofItems(ModItems.ENDIUM)),
    MYTHRIL("mythril", 6000, new int[] {12, 16, 15, 12}, 31, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.75f, 0.195f, () -> Ingredient.ofItems(ModItems.MYTHRIL)),
    REINFORCED_TRIPHITE("reinforcedtriphite", 8000, new int[] {16, 20, 18, 16}, 35, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.15f, 0.21f, () -> Ingredient.ofItems(ModItems.REINFORCED_TRIPHITE)),
    TITANIUM("titanium", 10000, new int[] {20,26,22,20}, 40, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5.0f, 0.23f, () -> Ingredient.ofItems(ModItems.TITANIUM)),
    PHYSICSIUM("physicsium", 100000, new int[] {100,100,100,100}, 50, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 10.0f, 0.25f, () -> Ingredient.ofItems(ModItems.PHYSICSIUM));
    ...
    public int getDurability(ArmorItem.Type type) {
        if(this==PHYSICSIUM || this==TITANIUM || this==REINFORCED_TRIPHITE || this==MYTHRIL || this==ENDIUM || this==PHENON || this==HYPHITE){
